...
const { parseImageBlob } = require("../utils/parseImageBlob");
...
describe("parseImageBlob", () => {
  it("reads XMP string", () => {
    expect(parseFile("images/imageWithXmp.bin")).toEqual({
      xmpString: `<x:xmpmeta xmlns:x="adobe:ns:meta/" x:xmptk="Adobe XMP Core 7.0-c000 1.000000, 0000/00/00-00:00:00        ">
 <rdf:RDF xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about=""
   ...
   crs:CameraProfileDigest="CB697D189316BD14A38C375D984AB105"
